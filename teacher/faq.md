...
- または，最初から音声つきのGoogleSlideを作成することもできます．例えば，[**こちら**](https://note.com/akazawa_studio/n/ne6a86f985c71) を参考にしてください．
...
- Zoomのバーチャル背景は、ビデオ使用時の背景に部屋の私有物が映り込むことで、個人のプライバシーが漏れる可能性を防ぐことが出来ます。そういった心配がない方は、バーチャル背景の使用にこだわる必要はないでしょう。あるいは、壁際に座って背景を壁だけにすれば、バーチャル背景は必要ありません。自宅のPCがマシン要件を満たしていない場合、スマートフォンを利用して授業を視聴することで、バーチャル背景を使用することも検討してみてください。ただし、履修人数が多い講義などはビデオを使用する可能性は低く、また、パワーポイントやホワイトボードの文字を読むためにも、スクリーンの大きなPCを使用した方が良いと思われます。
